...
class Memory:
    ...
    def createBoard(self):
        #for i in range(0, self.colNum): #becca commented this out and replaced with line below
        ...
        W = self.colNum
        i = 0
        #for row in range(0,H-1): #becca commented this out and replaced with line below
        for row in range(H):
            #for col in range(0,W-1): #becca commented this out and replaced with line below
            for col in range(W):
                #self.data[row][col] = self.numData[2*row+col] #becca commented this out and replaced with line below
                self.data[row][col] = self.numData[i]
                i += 1
